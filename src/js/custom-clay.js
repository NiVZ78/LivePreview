...
module.exports = function() {
  ...
  var originalColor = {
    'KEY_bgcolor'          : 0x000000, 
    'KEY_resistcolor'      : 0x00aaff,
    'KEY_bordercolor'      : 0xffffaa,
    'KEY_lcdbgcolor'       : 0xaaffff,
    'KEY_lcdtextcolor'     : 0x000055,
    'KEY_labelcolor'       : 0xffffff,
    'KEY_alarmcolor'       : 0xaaaa00,
    'KEY_shockcolor'       : 0xaaaa55,
    'KEY_shockarrowcolor'  : 0xaa0000
    };
  ...
  clayConfig.on(clayConfig.EVENTS.AFTER_BUILD, function() {
    ...
    clayConfig.getItemsByType('color').forEach(function(item) {
      ...
      customColor[item.appKey] = item.get();
